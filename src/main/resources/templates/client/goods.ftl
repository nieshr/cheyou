          ...
          <!--  <p class="p1">
            ...
            <div class="team_men">
                            <dl>
                                ...
                                <dd style="left:33%;<#if goods.groupSaleSoldNumber??><#if goods.groupSaleSoldNumber gt 3>background:#ff6700;</#if></#if>"></dd>
                                <dd style="left:66%;<#if goods.groupSaleSoldNumber??><#if goods.groupSaleSoldNumber gt 6>background:#ff6700;</#if></#if>"></dd>
                            </dl>
