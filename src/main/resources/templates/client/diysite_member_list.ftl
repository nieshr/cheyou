...
<div class="mymember_main">
    ...
    <form name="form1" action="/user/diysite/member" method="POST">  
<script type="text/javascript">
    ...
    <div class="mymember_mainbox">
        <div class="mymember_info mymember_info02">
            <div class="mymember_order_search"> 
                <a class="a001" href="/user/diysite/member">所属会员</a>
                <input class="mysub" type="submit" value="查询">
                <input class="mytext" type="text" name="keywords" onfocus="if(value=='用户名') {value=''}" onblur="if (value=='') {value='用户名'}" value="${keywords!'用户名'}">
                <div class="clear"></div>
            </div>
            <table>
                    ...
                    <#if member_page.totalPages gt 0>
                        <#list 1..member_page.totalPages as page>
                            <#if page <= 3 || (member_page.totalPages-page) < 3 || (member_page.number+1-page)?abs<3 >
                                ...
                                <#else>
                                    <a href="/user/diysite/member?page=${page-1}&keywords=${keywords!''}">${page}</a>
                                </#if>
                                <#assign continueEnter=false>
                            <#else>
                                <#if !continueEnter>
