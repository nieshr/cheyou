...
<input type="hidden" name="id" value="<#if site??>${site.id?c!""}</#if>" >
</div>
<!--导航栏-->
...
<div class="tab-content" style="display: block;">
    <dl>
        <dt>站点名称</dt>
        <dd>
            <input name="title" type="text" value="<#if site??>${site.title!""}</#if>" class="input normal" ajaxurl="/Verwalter/site/check<#if site??>?id=${site.id?c}</#if>" datatype="s" sucmsg=" ">
