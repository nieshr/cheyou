        ...
        <div class="rule-multi-radio">
            <span>
                <#list product_list as product>
                    <input type="radio" class="productIdRadio" name="productId" value="${product.id?c!""}" datatype="*0-255" <#if goods?? && goods.productId?? && goods.productId==product.id>checked="checked"</#if>>
