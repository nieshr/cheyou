  ...
  <input type="text" class="address" name="userMessage" value="" />
    ...
    <#if buy_goods_list??>
            ...
            <#list buy_goods_list as sg>
                ...
                <tr>
                    <td width="110"><a href="/touch/goods/${sg.goodsId?c}?qiang=3"><img src="${sg.goodsCoverImageUri!''}" width="100" height="100"/></a></td>
                    <td width="300" style="text-align:left;"><a href="/touch/goods/${sg.goodsId?c}?qiang=3">${sg.goodsTitle!''}</a></td>
